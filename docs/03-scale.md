...
1. It is the scale on which the recommended constants are actually defined.
...
2. It is the scale of the certified reference materials.
...
3. It is uniquely well-determined.
...
4. NBS is not thermodynamically proportional.
